...
void ClimateTraits::set_supports_freeze_protection(bool supports_freeze_protection) { supports_freeze_protection_ = supports_freeze_protection; }
...
bool ClimateTraits::get_supports_freeze_protection() const { return supports_freeze_protection_; }
