...
bool APIConnection::send_climate_state(climate::Climate *climate) {
  ...
  if (traits.get_supports_freeze_protection())
    resp.freeze_protection = climate->freeze_protection;
...
bool APIConnection::send_climate_info(climate::Climate *climate) {
  ...
  msg.supports_freeze_protection = traits.get_supports_freeze_protection();
...
void APIConnection::climate_command(const ClimateCommandRequest &msg) {
  ...
  if (msg.has_freeze_protection)
    call.set_freeze_protection(msg.freeze_protection);
  if (msg.has_fan_mode)
